...
int c1_quality = 2;                 //  quality on the 1..63 scale  - lower is better quality and bigger files - must be higher than the jpeg_quality in camera_config
int c1_avi_length = 60;            // how long a movie in seconds -- 1800 sec = 30 min

int c2_framesize = 7;
int c2_quality = 2;
int c2_avi_length = 60;
...
// Wifi Credentials
//
const char* ssid = "Nova3i";
const char* password = "U8qpfj9U";
